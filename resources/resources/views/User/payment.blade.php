...
$PAYU_BASE_URL = "https://sandboxsecure.payu.in";		// For Sandbox/Live Mode
    ...
    <form action="{{ $action }}" method="post" name="payuForm">
      <table>
        ...
        <tr>
          ...
          <td><input type="hidden" name="udf2" value="{{ $params }}"></td>
        </tr>
        <tr>
          <td><input type="hidden" name="udf3" value="{{ $trip_date }}"></td>
