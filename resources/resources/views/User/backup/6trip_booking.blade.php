  ...
  <div class="card shadow round10">
    ...
    <div class="tab-content">
          ...
          @foreach($midtrip as $midtrips)
            <div class="col-sm-6 mb-3">
              <div class="border p-3 shadow round10">
                ...
                <img src="{{ asset('storage/'.$midtrips->images) }}" alt="{{ $midtrips -> name }}" width="100%" height="250px" />
      ...
      <div id="previously_booked_date" class="container tab-pane fade"><br>
            ...
            <p>Ignore, If you are booking family trip.</p><br>
    ...
    <div class="card-footer text-center">
      <?php 
      $for = "general";
      $location = "payment/$data->id?payment=$trip_price&nop=$nop&nor=$nor&bt=$bt&nod=$nod&trip_date=$trip_date&bookingfor=$for" 
      ?>
      <a href={{ asset("$location") }} class="btn btn-primary">Pay Money</a>
      <!-- <div class="row"> -->
        <!-- <div class="col text-center"> -->
          <a href="#" class="text-center pull-right" data-toggle="modal" data-target="#myModal2"><i class="fa fa-share-alt"></i></a>
        <!-- </div> -->
      <!-- </div> -->
    </div>
  </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php $url = "http://127.0.0.1:8000/trip_details/trip_booking/1?nop=1&nor=1&bt=1&nod=0&trip_date=2021-01-13&trip_price=NjAxNA=="; ?>
