...
@section('data')
	<div class="container border p-3 bg-light shadow round10">
		<form method="post" action="meal_post" enctype="multipart/form-data">
            ...
            <!--detail close-->
            <div class="form-group">
                <label for="money">Enter price per head <i class="fa fa-info-circle" data-toggle="tooltip" title="Prices are end-to-end encrypted. No one, outside of this account not even TouristTribe can read."></i></label>
                <input type="number" class="form-control round10 shadow" name="money" placeholder="Per person & per day"/>
            </div>
