...
@section('data')
	<div class="container border p-3 bg-light shadow round10">
		<form method="post">
            ...
            <div class="form-group">
                <label for="money">Enter License/ permission Fee <i class="fa fa-info-circle" aria-hidden="true" data-toggle="tooltip" title="Prices are end-to-end encrypted. No one, outside of this account not even TouristTribe can read."></i></label>
                <input type="number" class="form-control round10 shadow" name="per_head_cost" placeholder="Per person" required/>
            </div>
            <div class="form-group">
